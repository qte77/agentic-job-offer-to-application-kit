...
- **`make ui-e2e`** — a comprehensive headless dashboard e2e (`scripts/ui_e2e.py`, patchright via the
  polyfetch venv) that complements the fast `make ui-check` smoke: it drives the local preview build
