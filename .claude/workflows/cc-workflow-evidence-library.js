...
const LANES = (cfg.lanes && cfg.lanes.length) ? cfg.lanes : [
  ...
  { key: 'ml', label: 'AI / ML engineer — applied AI, LLM apps, agentic systems', focus: 'building WITH models: agent orchestration, RAG, evals / observability, model integration and AI product features; the agentic / applied-AI work as the throughline, not generic backend', gapHint: 'applied / integration depth rather than foundational ML research or large-scale model training' },
  { key: 'fde', label: 'forward-deployed / solutions engineer', focus: 'customer-facing applied engineering: integrate and deploy the product into enterprise environments, build bespoke solutions, bridge engineering and customer; the solo end-to-end shipping breadth is the asset', gapHint: 'less direct enterprise customer-facing / pre-sales / large-account experience' },
